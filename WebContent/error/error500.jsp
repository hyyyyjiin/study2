...
<title>홈페이지 :: 페이지를 찾을 수 없습니다.</title>
...
<div id="wrap">
    <div id="header">
        ...
        <p class="menu"><a href="http://www.naver.com/">홈페이지홈</a> | <a onclick="window.open('https://help.naver.com/support/alias/contents2/naverhome/notfound.naver', 'help_naver', 'left=40,top=60,width=650,height=800,toolbar=1,resizable=0'); return false;">홈페이지 고객센터</a></p>
    </div>
    <div id="container">
        <h2>죄송합니다.<br />해당 서비스 접속이 원할하지 않습니다.</h2>
        <div class="content">
            <p> 방문 원하시는 페이지의 주소가 잘못 입력되었거나,
					변경 혹은 삭제되어 요청하신 페이지를 찾을 수가 없습니다.   
					입력하신 페이지의 주소가 정확한지 다시 한번 확인해 주시기 바랍니다.
					관련해 고객센터로 문의해 주시면 친절하게 안내해 드리겠습니다.</p>
            <p> 관련 문의사항은 <a onclick="window.open('https://help.naver.com/support/alias/contents2/naverhome/notfound.naver', 'help_naver', 'left=40,top=60,width=650,height=800,toolbar=1,resizable=0'); return false;">홈페이지 고객센터</a>에 알려주시면 친절하게 안내해 드리겠습니다.</p>
        </div>
        <form class="search" style="margin-top:50px;" name="search" action="http://search.naver.com/search.naver" method="get" onsubmit="emulAcceptCharset(this);" accept-charset="ks_c_5601-1987">
            ...
            <p class="sch_desc">홈페이지 검색으로 원하시는 페이지를 찾으실 수 있습니다.</p>
        </form>
    </div>
<div id="footer">
<address>
